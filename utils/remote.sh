...
vm_ip(){ case "$1" in 101) echo 192.168.50.101;;102) echo 192.168.50.102;;103) echo 192.168.50.103;;104) echo 192.168.50.104;;105) echo 192.168.50.105;;106) echo 192.168.50.106;;107) echo 192.168.50.107;;*) echo "$1";; esac; }
